...
## Current Version: v0.3.4 (Visual Design Alignment)

## Version History

| Version | Type | Summary |
|---------|------|---------|
| v0.3.4 | Polish | Visual Design Alignment — design system, unified components (Button/Card/Badge/PageHeader), phone-panel AppShell, BottomNav with floating + button, parent/tutor/specialist rewrites to match investor references. |
