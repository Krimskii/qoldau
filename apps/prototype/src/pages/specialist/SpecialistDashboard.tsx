...
export const SpecialistDashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* AI Insights */}
      <AIInsightCard
        text="Похоже, замечена связь между шумом и нервозностью. Возможно, стоит обратить внимание на сенсорную поддержку в групповых занятиях. Это наблюдение, не диагноз. Можно обсудить со специалистом."
        variant="warning"
      />
